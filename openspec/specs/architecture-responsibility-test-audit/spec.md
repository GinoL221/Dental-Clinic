...
Define the required outcomes for a diagnostic-first audit of Dental-Clinic architecture consistency, responsibility boundaries, and tests. The audit MUST produce evidence-backed findings and future remediation slices without authorizing code remediation in this change.
