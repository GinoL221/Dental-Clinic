...
public class AppointmentServiceImpl implements IAppointmentService {
  ...
  public AppointmentServiceImpl(
      ...
      AppointmentScheduleValidator scheduleValidator) {
  ...
  public AppointmentDTO save(AppointmentDTO appointmentDTO) {
    ...
    AppointmentScheduleValidator.ValidatedSchedule schedule =
        scheduleValidator.validateSchedule(
            appointmentDTO.getDate(), appointmentDTO.getTime(), null);
  ...
  public AppointmentDTO update(AppointmentDTO appointmentDTO) throws ResourceNotFoundException {
    ...
    AppointmentScheduleValidator.ValidatedSchedule schedule =
        scheduleValidator.validateSchedule(
            appointmentDTO.getDate(), appointmentDTO.getTime(), existing);
