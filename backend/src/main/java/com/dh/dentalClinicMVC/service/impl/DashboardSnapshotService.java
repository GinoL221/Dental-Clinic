    ...
    private void applyMonthlySection(DashboardSnapshotDTO snapshot) {
        try {
            ...
            for (int i = 0; i < size; i++) {
                ...
                monthlyStats.add(new DashboardStatsDTO.MonthlyStatsDTO(monthLabel, monthLabel, appointmentCount));
            }
    ...
    private void applyUpcomingSection(DashboardSnapshotDTO snapshot) {
        try {
            ...
            for (Object item : upcomingList) {
                ...
                DashboardSnapshotDTO.UpcomingAppointmentDTO dto = new DashboardSnapshotDTO.UpcomingAppointmentDTO();
