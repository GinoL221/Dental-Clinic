...
public class UserPasswordPolicy {
    ...
    // Password por defecto: nombre + apellido + últimos 3 dígitos del identificador único (DNI o matrícula)
    ...
    public String resolveForCreate(String rawPassword, String firstName, String lastName, Integer uniqueNumber) {
        String password = isBlank(rawPassword) ? buildDefaultPassword(firstName, lastName, uniqueNumber) : rawPassword;
