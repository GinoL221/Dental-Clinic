...
public class AppointmentStatusTransitionControllerTest {
  ...
  private Long createAppointment(Long dentistId, Long patientId, String date, String time)
      throws Exception {
    AppointmentRequestDTO dto =
        new AppointmentRequestDTO(dentistId, patientId, date, time, "Regular checkup");
