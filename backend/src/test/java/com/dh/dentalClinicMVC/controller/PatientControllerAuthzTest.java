...
class PatientControllerAuthzTest {
  ...
  private static Map<String, Object> fullUpdateBody(
      String firstName, String lastName, String email, int cardIdentity) {
  ...
  @Test
  public void whenPatientUpdatesOwnRecordWithDifferentEmail_thenEmailIsPreservedNotOverwritten()
      throws Exception {
    Patient own = seedPatient("original-email@test.com", 70012, "Original", "Name");

    Map<String, Object> body =
        fullUpdateBody("Updated", "Name", "attempted-new-email@test.com", 70012);
  ...
  public void whenPatientRequestsUpdateOfDifferentPathId_thenForbiddenAndVictimUnchanged()
    ...
    Map<String, Object> body =
        fullUpdateBody("Hijacked", "Hijacked", "victim-hijacked@test.com", 70003);
