...
public class AppointmentConflictTest {
  ...
  public void sameDentistSameSlotCreateShouldConflict() throws Exception {
    ...
    AppointmentRequestDTO app1 =
        new AppointmentRequestDTO(dentistId, patientId1, dateStr, "10:00", "First");
    mockMvc
        .perform(
            post("/appointments")
                .with(csrf())
    ...
    AppointmentRequestDTO app2 =
        new AppointmentRequestDTO(dentistId, patientId2, dateStr, "10:00", "Duplicate");
    mockMvc
        .perform(
            post("/appointments")
                .with(csrf())
  ...
  public void differentSlotOrDifferentDentistShouldSucceed() throws Exception {
    ...
    // Create first appointment -> 200
    AppointmentRequestDTO app1 =
        new AppointmentRequestDTO(dentistId1, patientId1, dateStr, "10:00", "First");
    mockMvc
        .perform(
            post("/appointments")
                .with(csrf())
    ...
    AppointmentRequestDTO app2 =
        new AppointmentRequestDTO(dentistId1, patientId2, dateStr, "11:00", "Different slot");
    mockMvc
        .perform(
            post("/appointments")
                .with(csrf())
    ...
    AppointmentRequestDTO app3 =
        new AppointmentRequestDTO(dentistId2, patientId2, dateStr, "10:00", "Different dentist");
    mockMvc
        .perform(
            post("/appointments")
                .with(csrf())
  ...
  public void cancelledAppointmentFreesSlot() throws Exception {
    ...
    mockMvc
        .perform(
            patch("/appointments/" + app1Id + "/status")
                .with(csrf())
                .contentType(MediaType.APPLICATION_JSON)
    ...
    AppointmentRequestDTO app2 =
        new AppointmentRequestDTO(dentistId, patientId2, dateStr, "10:00", "Recreated");
    mockMvc
        .perform(
            post("/appointments")
                .with(csrf())
  ...
  public void updateOwnSlotShouldSucceed() throws Exception {
    ...
    AppointmentRequestDTO app1 =
        new AppointmentRequestDTO(dentistId, patientId, dateStr, "10:00", "First");
    String response =
        mockMvc
            .perform(
                post("/appointments")
    ...
    AppointmentRequestDTO app1Update =
        new AppointmentRequestDTO(dentistId, patientId, dateStr, "10:00", "Updated desc");
    mockMvc
        .perform(
            put("/appointments/" + app1Id)
                .with(csrf())
                .contentType(MediaType.APPLICATION_JSON)
  ...
  public void updateCollisionShouldConflict() throws Exception {
    ...
    AppointmentRequestDTO app1 =
        new AppointmentRequestDTO(dentistId1, patientId1, dateStr, "10:00", "App 1");
    String response1 =
        mockMvc
            .perform(
                post("/appointments")
    ...
    AppointmentRequestDTO app2 =
        new AppointmentRequestDTO(dentistId2, patientId2, dateStr, "10:00", "App 2");
    mockMvc
        .perform(
            post("/appointments")
                .with(csrf())
    ...
    AppointmentRequestDTO app1Update =
        new AppointmentRequestDTO(dentistId2, patientId1, dateStr, "10:00", "App 1 colliding");
    mockMvc
        .perform(
            put("/appointments/" + app1Id)
                .with(csrf())
